...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-500 selection:bg-primary/30 relative">
      ...
      <main className="container mx-auto px-4 md:px-8 py-8 lg:py-12 flex flex-col gap-16 lg:gap-24 relative">
        {/* The Bento Identity */}
      ...
      {isVisible('section_footer') && (
        <div className="container mx-auto px-4 md:px-8 pb-12 relative">
